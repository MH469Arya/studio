  ...
  useEffect(() => {
    if (locale === 'hi') {
      ...
      const textsToTranslate: string[] = [
        ...
        'Waiting for sales data...', 'Sales Data Fetched', 'The AI found that you have sold', 'units of this product based on your order history.', 'AI will fetch this',
        ...
        'You can restart this tour anytime by clicking this button!', 'KlaGuide',
        'Step', 'Previous', 'Next', 'Finish',
        // Profile Page
